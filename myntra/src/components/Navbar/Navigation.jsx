...
const loginHandler=()=>{
                    ...
                    <div className='Mens-dropmenu-conatiner'>
                       ...
                       <div className='colm'>
                           ...
                           <header>Footerwear</header>
                                 ...
                                 <li> <a href='#'>Sandal & Floaters</a> </li>
                       ...
                       <div className='colm'>
                           ...
                           <ul className='mens-mens'>
                              ...
                              <header>Sports & Active Wear</header>
                                 ...
                                 <li><a href='#'>Activate T-shirts</a> </li>
 ...
 {/* women */}
              <li className='Women'  onClick={()=>{setMenu("Women")}}> <Link to="/Women" className='Women-achor'>  <a href="">WOMEN{menu==="Women"?<></>:<></>}</a></Link>
              <div className='Women-dropmenu'>
                    <div className='Women-dropmenu-conatiner'>
                       ...
                       <div className='colw'>
                           ...
                           <header>Western Wear</header>
                                 ...
                                 <li><a href='#'>Sweaters & Sweatershirts</a>  </li>
              ...
              {/* kids */}
              <li className='Kids' onClick={()=>{setMenu("Kid")}}><Link to="/Kid" className='Kids-achor'>  <a href="">KIDS {menu==="Kids"?<></>:<></>}</a></Link>
                   
              <div className='Kids-dropmenu'>
                    <div className='Kids-dropmenu-conatiner'>
                       <div className='colk'>
                           ...
                           <header>Boys Clothing</header>
                                 ...
                                 <li><a  href='#'>Jacket ,Sweaters & Sweatershirts</a></li>
                       ...
                       <div className='colk'>
                           ...
                           <header>Girls Clothing</header>
                                 ...
                                 <li><a  href='#'>Tights & Laggings</a></li>
                                 <li><a  href='#'>Jeans,Trousers & Capris</a></li>
                                 <li><a  href='#'>Jacket,Sweaters & Sweaters</a></li>
                                 <li><a  href='#'>Innerwear & Thermals</a></li>
                                 <li><a  href='#'>Nightwear & Loungewear</a></li>
                                 <li><a  href='#'>Value Packs</a></li>
                       ...
                       <div className='colk'>
                           ...
                           <header>Footerwear</header>
                                 <li><a href="#">Casual Shoes</a> </li>
                                 <li><a href='#'>Flipflops Shoes</a> </li>
                                 <li><a href='#'>Sports Shoes</a> </li>
                                 <li><a href='#'>Flats</a>  </li>
                   ...
                   <div className='colk'>
                         ...
                         <ul> 
                           ...
                           <li><a href="#">H&M</a> </li>
                                 ...
                                 <li><a href='#'>United Colors Of Benetto</a>  </li>
                                 <li> <a href='#'>YK</a> </li>
              ...
              <li className='Home' onClick={()=>{setMenu("Home")}}> <Link to ="/Home"  className="Home-achor"> <a href="">HOME & LIVING{menu==="Home"?<></>:<></>}</a></Link>
              ...
              <div className='Home-dropmenu'>
                    <div className='Home-dropmenu-conatiner'>
                       ...
                       <ul> 
                        <header>Flooring</header>
                                 ...
                                 <li><a href='#'>Floor Mats & Dharries</a> </li>
                       ...
                       <div className='col'>
                           ...
                           <ul className='Home-Home'>
                              ...
                              <header>Kitchen & Table</header>
                                 ...
                                 <li> <a href='#'>Table Covers & Furnishing</a> </li>
                   ...
                   <div className='col'>
                    ...
                    {/* Beauty */}
              <li className='Beauty' onClick={()=>{setMenu("Beauty")}}> <Link to="/Beauty" className='Beauty-achor'><a href='#'>BEAUTY</a>  {menu==="Beauty"?<></>:<></>}</Link>
               

               <div className='Beauty-dropmenu'>
              ...
              <li className='Studio' onClick={()=>{setMenu("Studio")}}><Link to="Studio">  <a href="">STUDIO{menu==="Studio"?<></>:<></>}</a></Link><span>NEW</span>
           ...
           {profilebutton && <div className='Profile-dropmenu'>
                    <div className='Profile-dropmenu-conatiner'>
                       <div className='colProfile'>
                           ...
                           <li style={{fontWeight:"400"}}>To access account and manage orders</li>
                           <Link to ="/Login"> <button type='Submit'  onClick={loginHandler  } className='btn-btn'>LOGIN / SIGNUP{menu==="Loghin"}</button></Link>
                             ...
                             <li>Gift Cards</li>
                             <li>Contact Us</li>
                             <li>Myntra Insider <span>NEW</span></li>
